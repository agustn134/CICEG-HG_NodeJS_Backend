...
class EmailService {
    ...
    async sendPasswordResetEmail(email, resetToken) {
        try {
            const resetLink = `${environments_1.environment.urlFront}/cambiar-password?token=${resetToken}`;
            const logoUrl = `${environments_1.environment.BASE_URL}/uploads/logos/logo-principal-importado.svg`;
            const mailOptions = {
                from: `"${environments_1.environment.hospitalName}" <siceghospital.slp.gto@gmail.com>`,
                to: email,
                subject: `Restablecimiento de Contraseña - ${environments_1.environment.systemName}`,
                html: `
          <!DOCTYPE html>
          <html lang="es">
          <head>
          ...
          <body>
            <div class="container">
              <div class="header">
                <img src="${logoUrl}" alt="${environments_1.environment.hospitalName}" class="logo-img">
                <div class="hospital-name">${environments_1.environment.hospitalName}</div>
              </div>
              ...
              <div class="content">
                ...
                <p>Hemos recibido una solicitud para restablecer la contraseña asociada a su cuenta en el <strong>${environments_1.environment.systemName}</strong> del <strong>${environments_1.environment.hospitalName}</strong>.</p>
                ...
                <div class="signature">
                  ...
                  ${environments_1.environment.hospitalName}</p>
                </div>
              </div>
              
              <div class="footer">
                <p><strong>Este es un mensaje automático. Por favor no responda a este correo.</strong></p>
                <p>© ${new Date().getFullYear()} ${environments_1.environment.hospitalName} - ${environments_1.environment.systemName} v${environments_1.environment.version}</p>
