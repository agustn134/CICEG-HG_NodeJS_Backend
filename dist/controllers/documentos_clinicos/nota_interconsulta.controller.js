...
exports.validarInterconsultaCompleta = exports.getAreasInterconsultaDisponibles = exports.estadisticasInterconsultas = exports.responderInterconsulta = exports.asignarMedicoInterconsulta = exports.getNotasInterconsultaPendientes = exports.searchNotasInterconsulta = exports.getNotasInterconsultaByPaciente = exports.getNotasInterconsultaByExpediente = exports.deleteNotaInterconsulta = exports.updateNotaInterconsulta = exports.createNotaInterconsulta = exports.getNotaInterconsultaById = exports.getNotasInterconsulta = void 0;
const database_1 = __importDefault(require("../../config/database"));
// ==========================================
// FUNCIONES CRUD BÁSICAS
// ==========================================
const getNotasInterconsulta = async (req, res) => {
    try {
        const { page = 1, limit = 10, area_interconsulta, medico_solicitante, fecha_inicio, fecha_fin, estado = 'all' // 'pendiente', 'respondida', 'all'
         } = req.query;
        let query = `
      SELECT 
        ni.*,
...
exports.getNotasInterconsulta = getNotasInterconsulta;
const getNotaInterconsultaById = async (req, res) => {
    try {
        const { id } = req.params;
        const query = `
      SELECT 
...
exports.getNotaInterconsultaById = getNotaInterconsultaById;
const createNotaInterconsulta = async (req, res) => {
    const client = await database_1.default.connect();
    try {
        await client.query('BEGIN');
        const { id_documento, area_interconsulta, motivo_interconsulta, diagnostico_presuntivo, examenes_laboratorio = false, examenes_gabinete = false, hallazgos, impresion_diagnostica, recomendaciones, id_medico_solicitante, id_medico_interconsulta } = req.body;
        // Validaciones
        ...
        if (area_interconsulta) {
            const areaQuery = await client.query('SELECT id_area_interconsulta FROM area_interconsulta WHERE id_area_interconsulta = $1', [area_interconsulta]);
...
exports.createNotaInterconsulta = createNotaInterconsulta;
const updateNotaInterconsulta = async (req, res) => {
    const client = await database_1.default.connect();
    try {
        await client.query('BEGIN');
        const { id } = req.params;
        ...
        const existsQuery = await client.query('SELECT id_nota_interconsulta FROM nota_interconsulta WHERE id_nota_interconsulta = $1', [id]);
        ...
        if (updateData.area_interconsulta) {
            const areaQuery = await client.query('SELECT id_area_interconsulta FROM area_interconsulta WHERE id_area_interconsulta = $1', [updateData.area_interconsulta]);
            if (areaQuery.rows.length === 0) {
                await client.query('ROLLBACK');
                return res.status(400).json({
                    success: false,
...
exports.updateNotaInterconsulta = updateNotaInterconsulta;
const deleteNotaInterconsulta = async (req, res) => {
    try {
        const { id } = req.params;
        const response = await database_1.default.query("DELETE FROM nota_interconsulta WHERE id_nota_interconsulta = $1 RETURNING *", [id]);
        if (response.rows.length === 0) {
            return res.status(404).json({
                success: false,
                message: "Nota de interconsulta no encontrada"
...
exports.deleteNotaInterconsulta = deleteNotaInterconsulta;
// ==========================================
// FUNCIONES ESPECÍFICAS Y CONSULTAS AVANZADAS
// ==========================================
const getNotasInterconsultaByExpediente = async (req, res) => {
    try {
...
exports.getNotasInterconsultaByExpediente = getNotasInterconsultaByExpediente;
const getNotasInterconsultaByPaciente = async (req, res) => {
    try {
...
exports.getNotasInterconsultaByPaciente = getNotasInterconsultaByPaciente;
const searchNotasInterconsulta = async (req, res) => {
    try {
...
exports.searchNotasInterconsulta = searchNotasInterconsulta;
const getNotasInterconsultaPendientes = async (req, res) => {
    try {
...
exports.getNotasInterconsultaPendientes = getNotasInterconsultaPendientes;
const asignarMedicoInterconsulta = async (req, res) => {
    const client = await database_1.default.connect();
    try {
        await client.query('BEGIN');
        const { id } = req.params;
        ...
        const notaQuery = await client.query('SELECT id_nota_interconsulta, id_medico_interconsulta FROM nota_interconsulta WHERE id_nota_interconsulta = $1', [id]);
        ...
        const medicoQuery = await client.query('SELECT id_personal_medico FROM personal_medico WHERE id_personal_medico = $1 AND activo = true', [id_medico_interconsulta]);
      ...
      RETURNING *
    `;
        const response = await client.query(updateQuery, [id, id_medico_interconsulta]);
        await client.query('COMMIT');
        return res.status(200).json({
            success: true,
...
exports.asignarMedicoInterconsulta = asignarMedicoInterconsulta;
const responderInterconsulta = async (req, res) => {
    const client = await database_1.default.connect();
    try {
        await client.query('BEGIN');
        const { id } = req.params;
        const { hallazgos, impresion_diagnostica, recomendaciones, examenes_laboratorio, examenes_gabinete } = req.body;
...
exports.responderInterconsulta = responderInterconsulta;
const estadisticasInterconsultas = async (req, res) => {
    try {
    ...
    `;
        const [porAreaResult, porMesResult, medicosResult] = await Promise.all([
            database_1.default.query(porAreaQuery),
...
exports.estadisticasInterconsultas = estadisticasInterconsultas;
const getAreasInterconsultaDisponibles = async (req, res) => {
    try {
        const query = `
      SELECT 
...
exports.getAreasInterconsultaDisponibles = getAreasInterconsultaDisponibles;
const validarInterconsultaCompleta = async (req, res) => {
    try {
        const { id } = req.params;
        const query = `
      SELECT 
...
exports.validarInterconsultaCompleta = validarInterconsultaCompleta;
