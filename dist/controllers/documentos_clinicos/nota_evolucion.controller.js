...
exports.getEstadisticasNotasEvolucion = exports.getNotasEvolucionByExpediente = exports.deleteNotaEvolucion = exports.updateNotaEvolucion = exports.createNotaEvolucion = exports.getNotaEvolucionById = exports.getResumenEvolucionClinica = exports.createNotaEvolucionRapida = exports.getNotaEvolucionByDocumento = exports.getEvolucionSignosVitales = exports.getNotasEvolucion = void 0;
...
const getNotasEvolucion = async (req, res) => {
    try {
        const { page = 1, limit = 10, id_documento, id_expediente, fecha_inicio, fecha_fin, buscar, dias_hospitalizacion_min, dias_hospitalizacion_max } = req.query;
...
// ==========================================
const getEvolucionSignosVitales = async (req, res) => {
    try {
...
exports.getEvolucionSignosVitales = getEvolucionSignosVitales;
// ==========================================
...
// ==========================================
const createNotaEvolucionRapida = async (req, res) => {
    try {
        const { id_expediente, id_medico, sintomas_signos, habitus_exterior, estado_nutricional, estudios_lab, evolucion_analisis, diagnosticos, plan_tratamiento, pronostico, indicaciones, interconsultas } = req.body;
...
exports.createNotaEvolucionRapida = createNotaEvolucionRapida;
// ==========================================
// OBTENER RESUMEN DE EVOLUCIÓN CLÍNICA
// ==========================================
const getResumenEvolucionClinica = async (req, res) => {
    try {
        const { id_expediente } = req.params;
        if (!id_expediente || isNaN(parseInt(id_expediente))) {
            return res.status(400).json({
...
exports.getResumenEvolucionClinica = getResumenEvolucionClinica;
// ==========================================
...
const createNotaEvolucion = async (req, res) => {
    try {
        ...
        const notaExistente = await database_1.default.query('SELECT id_nota_evolucion FROM nota_evolucion WHERE id_documento = $1', [id_documento]);
    ...
    try {
      ...
      `
        ...
        const [total, estancia, categorias, recientes] = await Promise.all([
            database_1.default.query(queries.totalNotas),
            database_1.default.query(queries.promedioEstancia),
            database_1.default.query(queries.categoriasEstancia),
            database_1.default.query(queries.notasRecientes)
        ]);
        return res.status(200).json({
            success: true,
