...
exports.getPacientesFrecuentesUrgencias = exports.getPanelUrgenciasTiempoReal = exports.getEstadisticasUrgencias = exports.getNotaUrgenciasByDocumento = exports.getNotasUrgenciasByExpediente = exports.deleteNotaUrgencias = exports.updateNotaUrgencias = exports.createNotaUrgencias = exports.getNotaUrgenciasById = exports.getNotasUrgencias = void 0;
...
const getNotasUrgencias = async (req, res) => {
    try {
        const { page = 1, limit = 15, id_documento, id_expediente, fecha_inicio, fecha_fin, buscar, estado_conciencia, area_interconsulta, prioridad_triage } = req.query;
...
const createNotaUrgencias = async (req, res) => {
    try {
        ...
        const notaExistente = await database_1.default.query('SELECT id_nota_urgencias FROM nota_urgencias WHERE id_documento = $1', [id_documento]);
        ...
        if (id_guia_diagnostico) {
            const guiaCheck = await database_1.default.query('SELECT id_guia_diagnostico FROM guia_clinica WHERE id_guia_diagnostico = $1 AND activo = true', [id_guia_diagnostico]);
        ...
        if (area_interconsulta) {
            const areaCheck = await database_1.default.query('SELECT id_area_interconsulta FROM area_interconsulta WHERE id_area_interconsulta = $1 AND activo = true', [area_interconsulta]);
...
const updateNotaUrgencias = async (req, res) => {
    try {
        ...
        const notaCheck = await database_1.default.query('SELECT id_nota_urgencias FROM nota_urgencias WHERE id_nota_urgencias = $1', [id]);
        ...
        if (updateData.id_guia_diagnostico) {
            const guiaCheck = await database_1.default.query('SELECT id_guia_diagnostico FROM guia_clinica WHERE id_guia_diagnostico = $1 AND activo = true', [updateData.id_guia_diagnostico]);
            if (guiaCheck.rows.length === 0) {
                return res.status(404).json({
                    success: false,
                    message: 'La guía clínica especificada no existe o no está activa'
        ...
        if (updateData.area_interconsulta) {
            const areaCheck = await database_1.default.query('SELECT id_area_interconsulta FROM area_interconsulta WHERE id_area_interconsulta = $1 AND activo = true', [updateData.area_interconsulta]);
            if (areaCheck.rows.length === 0) {
                return res.status(404).json({
                    success: false,
                    message: 'El área de interconsulta especificada no existe o no está activa'
...
// ==========================================
const getNotasUrgenciasByExpediente = async (req, res) => {
    try {
...
exports.getNotasUrgenciasByExpediente = getNotasUrgenciasByExpediente;
// ==========================================
// OBTENER NOTA DE URGENCIAS POR DOCUMENTO
// ==========================================
const getNotaUrgenciasByDocumento = async (req, res) => {
    try {
...
exports.getNotaUrgenciasByDocumento = getNotaUrgenciasByDocumento;
// ==========================================
// OBTENER ESTADÍSTICAS DE URGENCIAS
// ==========================================
const getEstadisticasUrgencias = async (req, res) => {
    try {
      ...
      `
        ...
        const [total, motivos, estados, interconsultas, horas, reingresos, tiempoAtencion] = await Promise.all([
            database_1.default.query(queries.totalAtenciones),
            database_1.default.query(queries.motivosAtencion),
            database_1.default.query(queries.estadosConciencia),
            database_1.default.query(queries.interconsultasSolicitadas),
            database_1.default.query(queries.atencionePorHora),
            database_1.default.query(queries.reingresos),
            database_1.default.query(queries.promedioTiempoAtencion)
        ]);
        return res.status(200).json({
            success: true,
...
exports.getEstadisticasUrgencias = getEstadisticasUrgencias;
// ==========================================
// OBTENER PANEL DE URGENCIAS EN TIEMPO REAL
// ==========================================
const getPanelUrgenciasTiempoReal = async (req, res) => {
    try {
        const query = `
      SELECT 
...
exports.getPanelUrgenciasTiempoReal = getPanelUrgenciasTiempoReal;
// ==========================================
// BUSCAR PACIENTES FRECUENTES EN URGENCIAS
// ==========================================
const getPacientesFrecuentesUrgencias = async (req, res) => {
    try {
        const { meses = 6, minimo_visitas = 3 } = req.query;
        const query = `
      SELECT 
        e.id_expediente,
        e.numero_expediente,
...
exports.getPacientesFrecuentesUrgencias = getPacientesFrecuentesUrgencias;
