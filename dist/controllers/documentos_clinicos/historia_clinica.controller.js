...
exports.deleteHistoriaClinica = exports.updateHistoriaClinica = exports.createHistoriaClinica = exports.getHistoriaClinicaById = exports.getHistoriasClinicas = void 0;
const database_1 = __importDefault(require("../../config/database"));
const getHistoriasClinicas = async (req, res) => {
    try {
        const response = await database_1.default.query("SELECT * FROM historia_clinica");
...
const getHistoriaClinicaById = async (req, res) => {
    try {
        ...
        const response = await database_1.default.query("SELECT * FROM historia_clinica WHERE id_historia_clinica = $1", [id]);
...
const deleteHistoriaClinica = async (req, res) => {
    try {
        const id = req.params.id;
        const response = await database_1.default.query("DELETE FROM historia_clinica WHERE id_historia_clinica = $1", [id]);
