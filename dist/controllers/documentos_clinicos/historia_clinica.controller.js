...
exports.getEstadisticasHistoriasClinicas = exports.getHistoriaClinicaByDocumento = exports.deleteHistoriaClinica = exports.updateHistoriaClinica = exports.createHistoriaClinica = exports.getHistoriaClinicaById = exports.getHistoriasClinicas = void 0;
...
const getHistoriasClinicas = async (req, res) => {
    try {
        const { page = 1, limit = 10, id_documento, id_expediente, buscar, fecha_inicio, fecha_fin } = req.query;
...
exports.getHistoriasClinicas = getHistoriasClinicas;
// ==========================================
...
const createHistoriaClinica = async (req, res) => {
    try {
        ...
        const historiaExistente = await database_1.default.query('SELECT id_historia_clinica FROM historia_clinica WHERE id_documento = $1', [id_documento]);
...
exports.createHistoriaClinica = createHistoriaClinica;
// ==========================================
...
const updateHistoriaClinica = async (req, res) => {
    try {
        ...
        const historiaCheck = await database_1.default.query('SELECT id_historia_clinica FROM historia_clinica WHERE id_historia_clinica = $1', [id]);
...
exports.updateHistoriaClinica = updateHistoriaClinica;
// ==========================================
...
exports.deleteHistoriaClinica = deleteHistoriaClinica;
// ==========================================
// OBTENER HISTORIA CLÍNICA POR DOCUMENTO
// ==========================================
const getHistoriaClinicaByDocumento = async (req, res) => {
    try {
...
exports.getHistoriaClinicaByDocumento = getHistoriaClinicaByDocumento;
// ==========================================
// OBTENER ESTADÍSTICAS DE HISTORIAS CLÍNICAS
// ==========================================
const getEstadisticasHistoriasClinicas = async (req, res) => {
    try {
        const queries = {
            totalHistorias: `
        SELECT COUNT(*) as total 
      ...
      `
        ...
        const [total, recientes, guiasMasUsadas] = await Promise.all([
            database_1.default.query(queries.totalHistorias),
            database_1.default.query(queries.historiasRecientes),
            database_1.default.query(queries.guiasClinicasMasUsadas)
        ]);
        return res.status(200).json({
            success: true,
...
exports.getEstadisticasHistoriasClinicas = getEstadisticasHistoriasClinicas;
