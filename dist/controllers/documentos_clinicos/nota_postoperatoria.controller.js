...
exports.getNotasPostoperatoriaByExpediente = exports.deleteNotaPostoperatoria = exports.updateNotaPostoperatoria = exports.createNotaPostoperatoria = exports.getNotaPostoperatoriaById = exports.getNotasPostoperatoria = void 0;
...
const deleteNotaPostoperatoria = async (req, res) => {
    try {
        const { id } = req.params;
        const response = await database_1.default.query("DELETE FROM nota_postoperatoria WHERE id_nota_postoperatoria = $1 RETURNING *", [id]);
        if (response.rows.length === 0) {
            return res.status(404).json({
                success: false,
                message: "Nota postoperatoria no encontrada"
...
// ==========================================
const getNotasPostoperatoriaByExpediente = async (req, res) => {
    try {
...
exports.getNotasPostoperatoriaByExpediente = getNotasPostoperatoriaByExpediente;
