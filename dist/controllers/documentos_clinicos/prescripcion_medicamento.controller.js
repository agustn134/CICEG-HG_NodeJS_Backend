...
const updatePrescripcionMedicamento = async (req, res) => {
    try {
        ...
        const prescripcionCheck = await database_1.default.query('SELECT id_prescripcion FROM prescripcion_medicamento WHERE id_prescripcion = $1', [id]);
...
// ==========================================
const getPrescripcionesByExpediente = async (req, res) => {
    try {
...
exports.getPrescripcionesByExpediente = getPrescripcionesByExpediente;
// ==========================================
...
exports.getEstadisticasPrescripciones = getEstadisticasPrescripciones;
