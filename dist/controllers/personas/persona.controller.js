...
exports.createPersona = exports.getPersonaById = exports.getPersonas = exports.deletePersona = exports.updatePersona = void 0;
...
`;
        ...
        const response = await database_1.default.query(insertQuery, values);
