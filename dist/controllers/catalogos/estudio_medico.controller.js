...
exports.getEstadisticasEstudiosMedicos = exports.getEstudiosMedicosActivos = exports.deleteEstudioMedico = exports.updateEstudioMedico = exports.createEstudioMedico = exports.getEstudioMedicoById = exports.getEstudiosMedicos = void 0;
...
const getEstudioMedicoById = async (req, res) => {
    ...
    `;
      ...
      LIMIT 10
    `;
        const solicitudesResponse = await database_1.default.query(solicitudesQuery, [id]);
...
const createEstudioMedico = async (req, res) => {
    try {
        const { clave, nombre, tipo, descripcion, requiere_ayuno = false, tiempo_resultado, activo = true } = req.body;
      ...
      `;
            const existeClaveResponse = await database_1.default.query(existeClaveQuery, [clave.trim()]);
...
const updateEstudioMedico = async (req, res) => {
    ...
    `;
      ...
      `;
            const duplicadoClaveResponse = await database_1.default.query(duplicadoClaveQuery, [clave.trim(), id]);
...
// ==========================================
const getEstudiosMedicosActivos = async (req, res) => {
    try {
...
exports.getEstudiosMedicosActivos = getEstudiosMedicosActivos;
// ==========================================
// OBTENER ESTADÍSTICAS DE ESTUDIOS MÉDICOS
// ==========================================
const getEstadisticasEstudiosMedicos = async (req, res) => {
    try {
        const query = `
      SELECT 
        em.tipo,
    ...
    `;
      ...
      LIMIT 10
    `;
        const masSolicitadosResponse = await database_1.default.query(masSolicitadosQuery);
        return res.status(200).json({
            success: true,
...
exports.getEstadisticasEstudiosMedicos = getEstadisticasEstudiosMedicos;
