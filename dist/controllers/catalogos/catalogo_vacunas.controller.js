...
exports.getEstadisticasVacunas = exports.getVacunasActivas = exports.deleteVacuna = exports.updateVacuna = exports.createVacuna = exports.getVacunaById = exports.getCatalogoVacunas = void 0;
const database_1 = __importDefault(require("../../config/database"));
// ==========================================
// OBTENER TODAS LAS VACUNAS DEL CATÁLOGO
// ==========================================
const getCatalogoVacunas = async (req, res) => {
    try {
...
exports.getCatalogoVacunas = getCatalogoVacunas;
// ==========================================
// OBTENER VACUNA POR ID
// ==========================================
const getVacunaById = async (req, res) => {
    try {
        const { id } = req.params;
    ...
    `;
      ...
      LIMIT 10
    `;
        const aplicacionesResponse = await database_1.default.query(aplicacionesQuery, [id]);
...
exports.getVacunaById = getVacunaById;
// ==========================================
// CREAR NUEVA VACUNA EN EL CATÁLOGO
// ==========================================
const createVacuna = async (req, res) => {
    try {
        const { nombre_vacuna, descripcion, tipo_vacuna, edad_aplicacion, dosis_requeridas = 1, intervalo_dosis, via_administracion = 'Intramuscular', activa = true } = req.body;
    ...
    `;
        const existeResponse = await database_1.default.query(existeQuery, [nombre_vacuna.trim()]);
...
const updateVacuna = async (req, res) => {
    try {
        const { id } = req.params;
        const { nombre_vacuna, descripcion, tipo_vacuna, edad_aplicacion, dosis_requeridas, intervalo_dosis, via_administracion, activa } = req.body;
        // Validar que el ID sea un número
        if (!id || isNaN(parseInt(id))) {
            return res.status(400).json({
                success: false,
    ...
    `;
        const duplicadoResponse = await database_1.default.query(duplicadoQuery, [nombre_vacuna.trim(), id]);
...
// ==========================================
const getVacunasActivas = async (req, res) => {
    try {
...
exports.getVacunasActivas = getVacunasActivas;
// ==========================================
// OBTENER ESTADÍSTICAS DEL CATÁLOGO DE VACUNAS
// ==========================================
const getEstadisticasVacunas = async (req, res) => {
    try {
        const query = `
      SELECT 
        cv.tipo_vacuna,
...
exports.getEstadisticasVacunas = getEstadisticasVacunas;
