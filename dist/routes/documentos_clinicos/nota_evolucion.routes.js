...
router.get("/expediente/:id_expediente/resumen", nota_evolucion_controller_1.getResumenEvolucionClinica);
// GET /api/documentos-clinicos/notas-evolucion/expediente/:id_expediente/signos-vitales - Evolución de signos vitales
router.get("/expediente/:id_expediente/signos-vitales", nota_evolucion_controller_1.getEvolucionSignosVitales);
...
router.post("/rapida", nota_evolucion_controller_1.createNotaEvolucionRapida);
