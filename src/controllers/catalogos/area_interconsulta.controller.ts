// src/controllers/catalogos/area_interconsulta.controller.ts
...
export const getAreaInterconsultaById = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const interconsultasResponse: QueryResult = await pool.query(interconsultasQuery, [id]);
...
// ==========================================
export const getAreasInterconsultaActivas = async (req: Request, res: Response): Promise<Response> => {
  try {
    const query = `
      SELECT 
...
// ==========================================
export const getEstadisticasInterconsultas = async (req: Request, res: Response): Promise<Response> => {
  try {
    const query = `
      SELECT 
        ai.id_area_interconsulta,
