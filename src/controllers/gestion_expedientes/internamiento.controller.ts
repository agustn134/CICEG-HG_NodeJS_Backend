...
export const getInternamientoById = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const internamientoResponse: QueryResult = await pool.query(internamientoQuery, [id]);
    ...
    const signosVitalesResponse: QueryResult = await pool.query(signosVitalesQuery, [id]);
    ...
    const historialCamasResponse: QueryResult = await pool.query(historialCamasQuery, [id]);
...
export const createInternamiento = async (req: Request, res: Response): Promise<Response> => {
  ...
  try {
    ...
    const expedienteResponse: QueryResult = await client.query(expedienteQuery, [id_expediente]);
    ...
    const internamientoActivoResponse: QueryResult = await client.query(internamientoActivoQuery, [id_expediente]);
    ...
    const medicoResponse: QueryResult = await client.query(medicoQuery, [id_medico_responsable]);
    ...
    if (id_cama) {
      ...
      const camaResponse: QueryResult = await client.query(camaQuery, [id_cama]);
      ...
      await client.query(
        `UPDATE cama SET estado = 'Ocupada' WHERE id_cama = $1`,
        [id_cama]
      );
    }
    ...
    if (id_servicio) {
      ...
      const servicioResponse: QueryResult = await client.query(servicioQuery, [id_servicio]);
    ...
    const internamientoResponse: QueryResult = await client.query(insertInternamientoQuery, [
      id_expediente,
      id_cama || null,
      id_servicio || null,
      fecha_ingreso,
    ...
    if (crear_nota_ingreso) {
      ...
      const tipoDocumentoResponse: QueryResult = await client.query(tipoDocumentoQuery);
      ...
      if (tipoDocumentoResponse.rows.length > 0) {
        ...
        const documentoResponse: QueryResult = await client.query(insertDocumentoQuery, [
          id_expediente,
    ...
    const validacionReingreso = await client.query(
      `SELECT validar_reingreso_paciente($1, $2) as requiere_validacion`,
      [id_expediente, id_medico_responsable]
    );
...
export const updateInternamiento = async (req: Request, res: Response): Promise<Response> => {
  ...
  try {
    ...
    const internamientoActualResponse: QueryResult = await client.query(internamientoActualQuery, [id]);
    ...
    if (id_cama && id_cama !== internamientoActual.id_cama) {
      ...
      const nuevaCamaResponse: QueryResult = await client.query(nuevaCamaQuery, [id_cama]);
      ...
      if (internamientoActual.id_cama) {
        await client.query(
          `UPDATE cama SET estado = 'Disponible' WHERE id_cama = $1`,
          [internamientoActual.id_cama]
        );
      }
...
// ==========================================
export const egresarPaciente = async (req: Request, res: Response): Promise<Response> => {
  const client = await pool.connect();
  ...
  try {
    ...
    const internamientoResponse: QueryResult = await client.query(internamientoQuery, [id]);
    ...
    const medicoResponse: QueryResult = await client.query(medicoQuery, [id_medico_egreso]);
    ...
    const internamientoActualizado: QueryResult = await client.query(updateInternamientoQuery, [
      fecha_egreso,
...
// ==========================================
export const getInternamientosActivos = async (req: Request, res: Response): Promise<Response> => {
  try {
...
// ==========================================
export const getDashboardInternamientos = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const estadisticasResponse: QueryResult = await pool.query(estadisticasQuery);
    ...
    const ocupacionServiciosResponse: QueryResult = await pool.query(ocupacionServiciosQuery);
    ...
    const estanciasProlongadasResponse: QueryResult = await pool.query(estanciasProlongadasQuery);
    ...
    const actividadRecienteResponse: QueryResult = await pool.query(actividadRecienteQuery);
...
// ==========================================
export const getHistorialInternamientosPaciente = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const pacienteExisteResponse: QueryResult = await pool.query(pacienteExisteQuery, [id_paciente]);
    ...
    const historialResponse: QueryResult = await pool.query(historialQuery, [id_paciente]);
    ...
    const estadisticasResponse: QueryResult = await pool.query(estadisticasQuery, [id_paciente]);
...
// ==========================================
export const buscarInternamientos = async (req: Request, res: Response): Promise<Response> => {
  try {
...
// ==========================================
export const transferirPaciente = async (req: Request, res: Response): Promise<Response> => {
  const client = await pool.connect();
  ...
  try {
    ...
    if (nueva_cama_id) {
      ...
      const nuevaCamaResponse: QueryResult = await client.query(nuevaCamaQuery, [nueva_cama_id]);
    ...
    if (nuevo_servicio_id) {
      ...
      const nuevoServicioResponse: QueryResult = await client.query(nuevoServicioQuery, [nuevo_servicio_id]);
    ...
    if (nuevo_medico_responsable_id) {
      ...
      const nuevoMedicoResponse: QueryResult = await client.query(nuevoMedicoQuery, [nuevo_medico_responsable_id]);
    ...
    const internamientoActualizado: QueryResult = await client.query(updateQuery, [
...
// ==========================================
export const getEstadisticasInternamientos = async (req: Request, res: Response): Promise<Response> => {
  try {
    ...
    const tipoEgresoResponse: QueryResult = await pool.query(tipoEgresoQuery, params);
    ...
    const servicioResponse: QueryResult = await pool.query(servicioQuery, params);
    ...
    const mesResponse: QueryResult = await pool.query(mesQuery, mesParams.slice(0, servicio_id ? mesParams.length : params.length));
    ...
    const medicosResponse: QueryResult = await pool.query(medicosQuery, params);
